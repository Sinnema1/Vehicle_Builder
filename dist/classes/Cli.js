...
class Cli {
    ...
    createTruck() {
        inquirer
            ...
            .then((answers) => {
            const truck = new Truck(Cli.generateVin(), answers.color, answers.make, answers.model, parseInt(answers.year), parseInt(answers.weight), parseInt(answers.topSpeed), parseFloat(answers.towingCapacity), []);
        ...
        inquirer
            ...
            // TODO: add statements to perform the tow action only if the selected vehicle is a truck. Call the findVehicleToTow method to find a vehicle to tow and pass the selected truck as an argument. After calling the findVehicleToTow method, you will need to return to avoid instantly calling the performActions method again since findVehicleToTow is asynchronous.
                ...
                if (selectedVehicle instanceof Truck) {
                    ...
                    console.log(`${selectedVehicle.make} ${selectedVehicle.model} is not a truck and cannot tow.`);
                }
            }
            // TODO: add statements to perform the wheelie action only if the selected vehicle is a motorbike
                ...
                if (selectedVehicle instanceof Motorbike) {
                    ...
                    console.log(`${selectedVehicle.make} ${selectedVehicle.model} is not a motorbike and cannot wheelie.`);
                }
            }
